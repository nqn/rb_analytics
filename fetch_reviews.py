...
def add_reviews(cur):
    ...
    for row in rows:
      ...
      for review_json in review_jsons["reviews"]:
          ...
          cur.execute("INSERT INTO Reviews(Id, Submitter, ShipIt, Added) VALUES (?,?,?,?)" , (review_id, review_submitter, review_shipit, review_added))
...
def main():
    try:
        ...
        cur.execute("CREATE TABLE Reviews(Id INTEGER PRIMARY KEY, Summary TEXT, Submitter TEXT, ShipIt INTEGER, Added TEXT)") 
